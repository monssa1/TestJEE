 ...
 */
package com.mycompany.maventdsi;
...
public class User implements Serializable {
    ...
    public User(Integer id, String login, String password, String nom, String prenom, String adresse) {
        this.id = id;
        this.login = login;
    ...
    public String toString() {
        return "com.mycompany.maventdsi.User[ id=" + id + " ]";
    }
